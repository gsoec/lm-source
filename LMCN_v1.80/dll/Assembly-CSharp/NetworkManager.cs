...
public class NetworkManager : IDisposable
{
	...
	// (get) Token: 0x0600258E RID: 9614 RVA: 0x0042C65C File Offset: 0x0042A85C
	...
	// Token: 0x06002591 RID: 9617 RVA: 0x0042C6B0 File Offset: 0x0042A8B0
	...
	// Token: 0x06002593 RID: 9619 RVA: 0x0042C840 File Offset: 0x0042AA40
	public static bool Miss()
	{
		return true;
	}

	// Token: 0x06002594 RID: 9620 RVA: 0x0042C844 File Offset: 0x0042AA44
	...
	// Token: 0x06002595 RID: 9621 RVA: 0x0042C8A0 File Offset: 0x0042AAA0
	public static void LetmeOut(long Please = 0L)
	{
		NetworkManager.Instance.SetStage(LoginPhase.LP_Fallout, Please, false);
	}
	...
	public static void Disconnect()
	{
		...
		MessagePacket.Clear();
		NetworkManager.GuestController.Drop(false);
		NetworkManager.Stage = LoginPhase.LP_Disconnect;
	}
