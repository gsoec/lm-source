...
.method public run()V
    ...
    const-string v0, "EXT-download-Runnable|onDownloadStart failed!"
    ...
    const-string v0, "EXT-download-Runnable"

    const-string v1, "CONTINUE_DOWNLOAD"

    invoke-static {v0, v1}, Lcom/igexin/b/a/c/a;->a(Ljava/lang/String;Ljava/lang/String;)V

    const-string v0, "EXT-download-Runnable|CONTINUE_DOWNLOAD"
    ...
    const-string v1, "EXT-download-Runnable|ResponseCode:"
    ...
    const-string v0, "EXT-download-Runnable|fileSize: chunked"
    ...
    const-string v3, "EXT-download-Runnable|fileSize: "
    ...
    invoke-static {v2, v0}, Lcom/igexin/push/extension/distribution/basic/g/f/a;->a(Lcom/igexin/push/extension/distribution/basic/g/a/a;Ljava/lang/String;)Ljava/lang/String;
    ...
    const-string v1, "EXT-download-Runnable|file address:"
    ...
    const-string v1, "EXT-download-Runnable|etag:"
    ...
    :cond_11
    const-string v0, "EXT-download-Runnable|not support continue"
    ...
    const-string v0, "EXT-download-Runnable|sdcard full"
    ...
    const-string v0, "EXT-download-Runnable|first download"
