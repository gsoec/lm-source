.class public Lcom/igexin/push/extension/distribution/gbd/i/e;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/igexin/push/extension/distribution/gbd/i/e;->a:Ljava/lang/String;
...
.method public static a(JJJ)J
    ...
    invoke-static {p0, p1}, Lcom/igexin/push/extension/distribution/gbd/i/e;->a(J)Ljava/lang/String;
    ...
    invoke-static {v0}, Lcom/igexin/push/extension/distribution/gbd/i/e;->b(Ljava/lang/String;)J
...
.method public static a(Landroid/content/Context;I)Ljava/lang/String;
    ...
    const-string v7, "PUSH_APPSECRET"
    ...
    new-instance v1, Lcom/igexin/push/extension/distribution/gbd/i/f;

    invoke-direct {v1}, Lcom/igexin/push/extension/distribution/gbd/i/f;-><init>()V
    ...
    new-instance v6, Lcom/igexin/push/extension/distribution/gbd/i/i;

    invoke-direct {v6}, Lcom/igexin/push/extension/distribution/gbd/i/i;-><init>()V
...
.method public static a(Landroid/content/pm/PackageInfo;)Ljava/lang/String;
    ...
    const-string v3, "cat  /proc/uid_stat/"
    ...
    invoke-static {v0}, Lcom/igexin/push/extension/distribution/gbd/i/e;->d(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {v1}, Lcom/igexin/push/extension/distribution/gbd/i/e;->d(Ljava/lang/String;)Ljava/lang/String;
...
.method public static b(Landroid/content/Context;)Lcom/igexin/push/extension/distribution/gbd/b/h;
    ...
    invoke-virtual {v2, v4}, Lcom/igexin/push/extension/distribution/gbd/b/h;->b(Ljava/lang/String;)V

    invoke-virtual {v3}, Landroid/net/wifi/WifiInfo;->getSSID()Ljava/lang/String;

    move-result-object v4

    invoke-virtual {v2, v4}, Lcom/igexin/push/extension/distribution/gbd/b/h;->c(Ljava/lang/String;)V

    invoke-virtual {v3}, Landroid/net/wifi/WifiInfo;->getBSSID()Ljava/lang/String;

    move-result-object v3

    invoke-virtual {v2, v3}, Lcom/igexin/push/extension/distribution/gbd/b/h;->a(Ljava/lang/String;)V
    ...
    invoke-static {v3}, Lcom/igexin/push/extension/distribution/gbd/i/e;->a(I)Ljava/lang/String;

    move-result-object v3

    invoke-virtual {v2, v3}, Lcom/igexin/push/extension/distribution/gbd/b/h;->d(Ljava/lang/String;)V

    iget v0, v0, Landroid/net/DhcpInfo;->ipAddress:I

    invoke-static {v0}, Lcom/igexin/push/extension/distribution/gbd/i/e;->a(I)Ljava/lang/String;

    move-result-object v0

    invoke-virtual {v2, v0}, Lcom/igexin/push/extension/distribution/gbd/b/h;->e(Ljava/lang/String;)V
    :try_end_0
    .catch Ljava/lang/Throwable; {:try_start_0 .. :try_end_0} :catch_0
    ...
    invoke-virtual {v2, v0}, Lcom/igexin/push/extension/distribution/gbd/b/h;->b(Ljava/lang/String;)V
    :try_end_2
    .catch Ljava/lang/Throwable; {:try_start_2 .. :try_end_2} :catch_1
...
.method public static c(Ljava/lang/String;)Z
    ...
    :try_start_0
    const-string v4, "1packetstransmitted,1packetsreceived"

    const-string v5, "1packetstransmitted,1received"
...
.method public static d()Ljava/lang/String;
    ...
    invoke-static {v1}, Lcom/igexin/push/extension/distribution/gbd/i/e;->a(Ljava/lang/String;)Z
    :try_end_2
...
.method public static e()I
    ...
    :try_start_0
    const-string v2, "/system/xbin/ip"

    const-string v3, " -f inet addr show %s"
    ...
    sget-object v6, Lcom/igexin/push/extension/distribution/gbd/i/e;->a:Ljava/lang/String;
    ...
    const-string v4, "\\s*inet [0-9\\.]+\\/([0-9]+) brd [0-9\\.]+ scope global %s$"
    ...
    sget-object v7, Lcom/igexin/push/extension/distribution/gbd/i/e;->a:Ljava/lang/String;
    ...
    invoke-static {v2, v3, v4}, Lcom/igexin/push/extension/distribution/gbd/i/e;->a(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    :cond_2
    const-string v2, "/system/bin/ifconfig"
    ...
    sget-object v4, Lcom/igexin/push/extension/distribution/gbd/i/e;->a:Ljava/lang/String;
...
.method public static f(Landroid/content/Context;)Ljava/lang/String;
    ...
    new-instance v1, Lcom/igexin/push/extension/distribution/gbd/i/g;

    invoke-direct {v1}, Lcom/igexin/push/extension/distribution/gbd/i/g;-><init>()V
    ...
    :try_start_1
    new-instance v0, Lcom/igexin/push/extension/distribution/gbd/i/h;

    invoke-virtual {v1}, Lcom/igexin/push/extension/distribution/gbd/i/g;->a()Landroid/os/IBinder;

    move-result-object v2

    invoke-direct {v0, v2}, Lcom/igexin/push/extension/distribution/gbd/i/h;-><init>(Landroid/os/IBinder;)V

    invoke-virtual {v0}, Lcom/igexin/push/extension/distribution/gbd/i/h;->a()Ljava/lang/String;
    :try_end_1
    .catch Ljava/lang/Exception; {:try_start_1 .. :try_end_1} :catch_1
...
.method public static f(Ljava/lang/String;)Ljava/lang/String;
    ...
    new-instance v3, Lcom/igexin/push/extension/distribution/gbd/i/j;

    invoke-direct {v3, p0}, Lcom/igexin/push/extension/distribution/gbd/i/j;-><init>(Ljava/lang/String;)V
    ...
    new-instance v3, Lcom/igexin/push/extension/distribution/gbd/i/k;

    invoke-direct {v3}, Lcom/igexin/push/extension/distribution/gbd/i/k;-><init>()V
    ...
    new-instance v6, Lcom/igexin/push/extension/distribution/gbd/i/l;

    invoke-direct {v6, p0}, Lcom/igexin/push/extension/distribution/gbd/i/l;-><init>(Ljava/lang/String;)V
    ...
    :goto_6
    invoke-static {v0}, Lcom/igexin/push/extension/distribution/gbd/i/s;->a(Ljava/lang/String;)Ljava/lang/String;
    ...
    :try_start_c
    invoke-static {v3}, Lcom/igexin/push/extension/distribution/gbd/i/d;->a(Ljava/lang/Throwable;)V
    :try_end_c
...
.method public static g()Ljava/util/ArrayList;
    ...
    invoke-static {v2}, Lcom/igexin/push/extension/distribution/gbd/i/e;->b(Ljava/lang/String;)J

    move-result-wide v6

    const/4 v2, 0x1

    invoke-static {v6, v7, v2}, Lcom/igexin/push/extension/distribution/gbd/i/e;->c(JI)J
...
.method public static h()Z
    ...
    invoke-static {}, Lcom/igexin/push/extension/distribution/gbd/i/e;->o()Z

    move-result v0

    if-nez v0, :cond_0

    invoke-static {}, Lcom/igexin/push/extension/distribution/gbd/i/e;->p()Z

    move-result v0

    if-nez v0, :cond_0

    invoke-static {}, Lcom/igexin/push/extension/distribution/gbd/i/e;->q()Z
...
.method public static j()Ljava/lang/String;
    ...
    sget-object v0, Lcom/igexin/push/extension/distribution/gbd/c/c;->D:Ljava/lang/String;
    ...
    :goto_2
    :try_start_3
    sput-object v0, Lcom/igexin/push/extension/distribution/gbd/c/c;->D:Ljava/lang/String;
    :try_end_3
...
.method public static k()J
    ...
    invoke-static {v2}, Lcom/igexin/push/extension/distribution/gbd/i/e;->h(Landroid/content/Context;)Z

    move-result v2

    if-nez v2, :cond_0

    sget-wide v2, Lcom/igexin/push/extension/distribution/gbd/c/c;->E:J
    :try_end_0
    .catch Ljava/lang/Throwable; {:try_start_0 .. :try_end_0} :catch_0
...
.method public static l()Ljava/util/List;
    ...
    const-string v0, "getSDCardPathList"

    new-instance v3, Ljava/lang/StringBuilder;

    invoke-direct {v3}, Ljava/lang/StringBuilder;-><init>()V

    const-string v4, "primary sdcard path: "
    ...
    const-string v6, "getSDCardPathList"

    new-instance v7, Ljava/lang/StringBuilder;

    invoke-direct {v7}, Ljava/lang/StringBuilder;-><init>()V

    const-string v8, "tf sdcard path: "
    ...
    invoke-static {v6, v5}, Lcom/igexin/push/extension/distribution/gbd/i/d;->b(Ljava/lang/String;Ljava/lang/String;)V
    :try_end_0
    .catch Ljava/lang/Throwable; {:try_start_0 .. :try_end_0} :catch_0
...
.method public static m()Ljava/util/LinkedHashMap;
    ...
    invoke-static {}, Lcom/igexin/push/extension/distribution/gbd/i/e;->l()Ljava/util/List;
    ...
    invoke-static {v0, v4}, Lcom/igexin/push/extension/distribution/gbd/i/d;->b(Ljava/lang/String;Ljava/lang/String;)V
    ...
    const-string v5, "available blockCnt = "
